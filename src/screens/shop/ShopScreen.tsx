...
export default function ShopScreen() {
  ...
  const { data, isLoading, refetch, isRefetching, hasNextPage, fetchNextPage, isFetchingNextPage } = useProducts();
  ...
  const filteredProducts = useMemo(() => {
    ...
    return products.filter((p: ProductListItem) => p.title?.toLowerCase().includes(q));
  }, [products, search]);
