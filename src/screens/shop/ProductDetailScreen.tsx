...
import { useProductDetail, useCreatePurchase, useDownload } from '@/hooks/useShop';
  ...
  const handlePurchase = async () => {
    ...
    try {
      ...
      purchaseMutation.mutate(
        ...
        {
          onSuccess: () => {
            showToast('success', 'Purchased', 'You can now download this product');
          },
          onError: (error) => {
            showToast('error', 'Error', error.message || 'Failed to validate purchase');
          },
