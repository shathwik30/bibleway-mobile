...
export function useApiBible<T = unknown>(
  path: string,
...
export function useBibleDetail(bibleId: string) {
  return useQuery({
    ...
    queryFn: () =>
      api.get<BibleDetail>(ENDPOINTS.bible.apiBibleProxy(`bibles/${bibleId}`)),
    ...CACHE_DURATIONS.bibleVersions,
    enabled: !!bibleId,
  });
}

export function useBibleVersions(params?: {
  language?: string;
  abbreviation?: string;
}) {
...
export function useBibleBooks(bibleId: string) {
  return useQuery({
    ...
    queryFn: () =>
      api.get<BibleBook[]>(
        ENDPOINTS.bible.apiBibleProxy(`bibles/${bibleId}/books`),
      ),
    ...CACHE_DURATIONS.bibleContent,
    enabled: !!bibleId,
  });
...
export function useBibleBookSections(bibleId: string, bookId: string) {
  return useQuery({
    ...
    queryFn: () =>
      api.get<BibleSectionSummary[]>(
        ENDPOINTS.bible.apiBibleProxy(
          `bibles/${bibleId}/books/${bookId}/sections`,
        ),
      ),
    ...CACHE_DURATIONS.bibleContent,
    enabled: !!bibleId && !!bookId,
...
export function useBibleChapterSections(bibleId: string, chapterId: string) {
  return useQuery({
    ...
    queryFn: () =>
      api.get<BibleSectionSummary[]>(
        ENDPOINTS.bible.apiBibleProxy(
          `bibles/${bibleId}/chapters/${chapterId}/sections`,
        ),
      ),
    ...CACHE_DURATIONS.bibleContent,
...
export function useBibleSection(bibleId: string, sectionId: string) {
  return useQuery({
    ...
    queryFn: () =>
      api.get<BibleSectionContent>(
        ENDPOINTS.bible.apiBibleProxy(
          `bibles/${bibleId}/sections/${sectionId}`,
        ),
...
export function useAudioBibles(params?: {
  language?: string;
  bibleId?: string;
}) {
  return useQuery({
    ...
    queryFn: () =>
      api.get<AudioBible[]>(
        ENDPOINTS.bible.apiBibleProxy("audio-bibles/"),
        params,
      ),
    ...CACHE_DURATIONS.bibleVersions,
  });
...
export function useAudioBibleDetail(audioBibleId: string) {
  return useQuery({
    ...
    queryFn: () =>
      api.get<AudioBibleDetail>(
        ENDPOINTS.bible.apiBibleProxy(`audio-bibles/${audioBibleId}`),
      ),
    ...CACHE_DURATIONS.bibleVersions,
...
export function useAudioBibleBooks(audioBibleId: string) {
  return useQuery({
    ...
    queryFn: () =>
      api.get<BibleBook[]>(
        ENDPOINTS.bible.apiBibleProxy(`audio-bibles/${audioBibleId}/books`),
      ),
    ...CACHE_DURATIONS.bibleContent,
    enabled: !!audioBibleId,
  });
...
export function useAudioBibleBookChapters(
  audioBibleId: string,
  bookId: string,
) {
  return useQuery({
